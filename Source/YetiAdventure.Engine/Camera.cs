...
namespace YetiAdventure.Engine
{
    ...
    public class Camera
    {
        ...
        /// <summary>
        /// The worldspace position that the camera will attempt to target. This is only an attempt, and in certain
        /// cases the camera's actual position will not be able to match the target position. (Camera movement can
        /// be constrained by level bounds.)
        /// </summary>
...
/*
        ...
        public void HandleInput(KeyboardState kbState)
        {
        ...
        {
            // @ZOOMTEST
            //Zoom = (float)(Math.Sin(inGametime.TotalGameTime.TotalSeconds) * 4 + 20.0f);
            // @ROTATIONTEST
